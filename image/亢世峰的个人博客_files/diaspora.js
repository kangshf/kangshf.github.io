    ...
    player: function() {
        ...
        p.on({
            'timeupdate': function() {
                ...
                if (progress / 5 <= 1)="" {="" p[0].volume="progress" 5;="" }else="" }="" },="" 'ended':="" function()="" $('.icon-pause').removeclass('icon-pause').addclass('icon-play')="" 'playing':="" $('.icon-play').removeclass('icon-play').addclass('icon-pause')="" })="" loading:="" var="" w="window.innerWidth;" css="<style class="loaderstyle" id="loaderstyle" +="" +'"="">'+
